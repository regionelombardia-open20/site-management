 ...
 * @var amos\sitemanagement\models\search\SiteManagementSliderSearch $model
 */
$this->title = Yii::t('amossitemanagement', 'Sliders');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="site-management-slider-index">
    <?php // echo $this->render('_search', ['model' => $model]);  ?>

    <p>
        <?php /* echo         Html::a(Module::t('amossitemanagement', 'Nuovo {modelClass}', [
          'modelClass' => 'Site Management Slider',
        ...
        'gridView' => [
            'columns' => [
                ...
                [
                    ...
                    'format' => 'datetime',
                    'label' => Module::t('amossistemanagement', 'Creato il')
                ],
