 ...
 * @var amos\sitemanagement\models\search\SiteManagementTemplateSearch $model
 * @var yii\widgets\ActiveForm $form
 */
?>

<div class="site-management-template-search element-to-toggle" data-toggle-element="form-search">
    ...
    <div class="col-sm-6 col-lg-4">    <?= $form->field($model, 'view_path') ?></div>
    <div class="col-sm-6 col-lg-4">    <?= $form->field($model, 'created_at') ?></div> <?php // echo $form->field($model, 'updated_at') ?>
