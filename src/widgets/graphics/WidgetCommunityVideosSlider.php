...
class WidgetCommunityVideosSlider extends WidgetGraphic
{
    ...
    public function init()
    {
        ...
        $this->setCode('COMMUNITY_VIDEOS_SLIDER');
        $this->setLabel(Module::t('amossitemanagement', 'Slider Video'));
    ...
    {
        $viewToRender = 'community_videos_slider';
