...
use amos\sitemanagement\models\search\SiteManagementLandingSearch;
...
/**
 * SiteManagementLandingController implements the CRUD actions for SiteManagementLanding model.
 */
class SiteManagementLandingController extends CrudController
{
    ...
    public function init()
    {
        ...
        $this->setModelObj(new SiteManagementLanding());
        $this->setModelSearch(new SiteManagementLandingSearch());
    ...
    /**
     * Displays a single SiteManagementLanding model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new SiteManagementLanding model.
    ...
    public function actionCreate()
    {
        ...
        $model = new SiteManagementLanding;
    ...
    /**
     * Updates an existing SiteManagementLanding model.
    ...
    /**
     * Deletes an existing SiteManagementLanding model.
